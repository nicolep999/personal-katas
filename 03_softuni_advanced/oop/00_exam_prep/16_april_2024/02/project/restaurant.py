class Restaurant:
    ...
    def get_waiters(self, min_earnings=None, max_earnings=None):
        filtered_waiters = [
            ...
            if (min_earnings is None or waiter.get("total_earnings", 0) >= min_earnings)
            and (
...
print(restaurant.add_waiter("John"))
print(restaurant.add_waiter("Jane"))
print(restaurant.get_waiters())
