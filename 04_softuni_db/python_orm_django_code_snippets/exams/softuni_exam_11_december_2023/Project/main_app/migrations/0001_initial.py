# Generated by Django 5.0.4 on 2025-03-28 10:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surface_type', models.CharField(default='Not Selected', max_length=12)),
            ],
        ),
        migrations.CreateModel(
            name='Match',
            fields=[
                ...
                ('winner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='winner_player', to='main_app.tennisplayer')),
